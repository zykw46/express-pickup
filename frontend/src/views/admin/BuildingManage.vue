    ...
    <el-card>
      <template #header>
        <div class="card-header">
          <span>宿舍楼管理</span>
          <el-button type="primary" @click="handleAdd">添加宿舍楼</el-button>
        </div>
      </template>

      <el-table :data="tableData" v-loading="loading" border>
        <el-table-column type="index" label="序号" width="60" header-align="center" align="center" />
        <el-table-column prop="buildingName" label="楼栋名称" header-align="center" align="center" />
        <el-table-column prop="sortOrder" label="排序" width="80" header-align="center" align="center" />
